    ...
    public partial class FormProveedor : Form
    {
        ...
        public void ActualizarGrid()
        {
            ...
            con.ActualizarGrid(this.dataGridView1,
                "Select IdProveedor, Descripcion, Direccion from ProveedorTBL");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string consulta = "insert into ProveedorTBL (Descripcion, Direccion) values ('" + textBox1.Text + "','" + textBox2.Text + "' );";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Conectar();
                string consulta = "delete from ProveedorTBL where IdProveedor = '" + Id + "' ; ";
                con.EjecutarSql(consulta);
                this.ActualizarGrid();
                con.Desconectar();
            }
